# Csharp övning - Flöde via loopar och strängmanipulation
...
3. Skapa enoändlig iteration, alltså något som inte tar slut innan vi säger till att den
...
3. Programmet ser om personen är ungdom (under20 år)
